<?php
   ...
   extract(shortcode_atts(array(
    ...
    echo'<div id="'.uniqid("fws_").'" class="wpb_row vc_row-fluid '. $main_class . $parallax_class . ' ' . $vertically_center_class . ' ' . $class . ' ' . $etxra_class.' " '.$using_custom_text_color.' style="'.$style.'">';
