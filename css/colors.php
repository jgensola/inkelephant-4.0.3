...
function nectar_colors() {
	...
	.toggle.open h3 a, .tabbed > ul li a.active-tab, [class*=" icon-"], .icon-normal, .bar_graph li span, .nectar-button[data-color-override="false"], #footer-outer #footer-widgets .col input[type="submit"],
	...
	if(!empty($options['cta-text-color'])) {
	 ...
	 echo '#page-header-bg h1, #page-header-bg .subheader, #portfolio-nav a i, #portfolio-nav a i, page-header-bg #portfolio-nav a i, #page-header-bg span { color: '. $font_color .'!important; } ';
